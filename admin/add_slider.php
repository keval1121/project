<?php include 'header.php'; 
  ...
  if(isset($_POST['save']))
  {
      $title = $_POST['title'];
      $dis = $_POST['dis'];
      $image = rand(0,9999999).$_FILES['slider_image']['name'];
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">add_slider</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
              ...
              <form method="POST" enctype="multipart/form-data">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="" placeholder="Enter dis..." name="dis">
                  </div>
                  <div class="form-group">
                ...
                <div class="card-footer">
                  <input type="submit" class="btn btn-primary" value="Add Slider" name="save">
                </div>
              </form>
            </div>
